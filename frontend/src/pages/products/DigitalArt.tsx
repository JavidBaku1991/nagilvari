...
const DigitalArt: React.FC = () => {
  ...
  const maxPrice = Math.max(...digitalArt.map(p => p.price));
  ...
  }, [digitalArt, searchQuery, sortBy, priceRange]);
  ...
  return (
    <Box sx={{ 
      ...
      <Container maxWidth="lg">
        ...
        >
          {t('categories.digitalArt.title')}
        </Typography>
        <Typography variant="subtitle1" align="center" sx={{ mb: 4, color: '#666' }}>
          {t('categories.digitalArt.description')}
        </Typography>
