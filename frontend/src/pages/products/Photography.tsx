...
const Photography: React.FC = () => {
  ...
  const maxPrice = Math.max(...photography.map(p => p.price));
  ...
  }, [photography, searchQuery, sortBy, priceRange]);
  ...
  return (
    <Box sx={{ 
      ...
      <Container maxWidth="lg">
        ...
        >
          {t('categories.photography.title')}
        </Typography>
        <Typography variant="subtitle1" align="center" sx={{ mb: 4, color: '#666' }}>
          {t('categories.photography.description')}
        </Typography>
